...
class Messages():
      HELP_MSG = [
        ...
        "**Setup**\n__First of all add me in the group as admin with ban users permission and in the channel as admin.\nNote: Only creator/owner of the group can setup me and i will leave the chat if i am not an admin in the chat.__",
       ...
       "**Devloped By @ARKBotz**\n\n**Use /fsub chat_id/username to make me functional.\n\nExample : /fsub -1001242765980  or  /forcesubscribe : -1001242765980\n\n Type in GROUP as like given in example After Adding Bot in Group and The Channel You want to Subscribe By Members.**"
      ]
